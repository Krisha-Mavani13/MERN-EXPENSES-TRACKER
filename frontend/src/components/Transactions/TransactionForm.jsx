    ...
    >
      ...
      <div className="flex flex-col space-y-1">
        ...
        <input
          ...
          placeholder="Amount"
          id="amount"
          className="w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 py-2 px-3"
        />
      ...
      <div className="flex flex-col space-y-1">
        <label htmlFor="category" className=" text-gray-700 font-medium">
          <FaRegCommentDots className="text-blue-500 inline mr-2" />
          Category
        </label>
        <select
          {...formik.getFieldProps("category")}
          id="category"
          className="w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
        >
      ...
      <div className="flex flex-col space-y-1">
        ...
        <textarea
          ...
          className="w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 py-2 px-3"
        ></textarea>
        {formik.touched.dadescriptionte && formik.errors.description && (
          <p className="text-red-500 text-xs italic">
